  ...
  return (
    <div className="w-56 shrink-0">
      ...
      <div
        ...
        className={`h-full min-h-full w-full transition-colors ${active ? "bg-grape-200/50" : "bg-grape-300/0"
          }`}
      >
        {filteredCards.map((c) => {
...
const BurnBarrel = ({ setCards }) => {
  ...
  return (
    <div
      ...
      onDragOver={handleDragOver}
      onDragLeave={handleDragLeave}
      className={`w-20 h-20 fixed xl:static top-96 right-2 sm:size-32 sm:right-12 grid size-32 shrink-0 place-content-center self-center lg:self-start rounded border text-3xl ${active
